...
const testimonials = [
  {
    ...
    author: "Sarah & James",
    imgSrc: "", // Add image source here if needed
  },
  {
    id: 2,
    quote: "Professional and Creative",
    text: "Professional, effective, and truly knowledgeable in digital marketing.",
    author: "Linda M.",
    imgSrc: "", // Add image source here if needed
  },
  {
    ...
    text: "They managed to capture the essence of my brand in every shot. The photos are now proudly displayed on my website!",
    author: "Mark T.",
    imgSrc: "", // Add image source here if needed
  },
];
